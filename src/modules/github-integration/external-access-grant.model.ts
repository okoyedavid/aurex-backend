...
const externalAccessGrantSchema = new mongoose.Schema(
  {
    ...
    managedPrincipalExternalId: { type: Number, default: null },
    managedPrincipalUsername: { type: String, trim: true, default: null },
    desiredPrincipalExternalId: { type: Number, default: null },
    desiredPrincipalUsername: { type: String, trim: true, default: null },
    pendingPrincipalExternalId: { type: Number, default: null },
    pendingPrincipalUsername: { type: String, trim: true, default: null },
    pendingManagedGrantCreated: { type: Boolean, required: true, default: false },
    pendingBaselinePermission: { type: String, default: null },
